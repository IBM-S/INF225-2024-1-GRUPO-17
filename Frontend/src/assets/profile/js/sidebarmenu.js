    ...
    let AdminMenu = function () {
      ...
      AdminMenu.prototype.init = function init() {
        ...
        $(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(Event.CLICK_DATA_API, function (e) {
          let _this = $(this);
          let _parent = _this.parent(self._config.parentTrigger);
          let _siblings = _parent.siblings(self._config.parentTrigger).children(self._config.triggerElement);
          let _list = _parent.children(self._config.subMenu);
